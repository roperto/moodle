 ...
 */
class backup_workshepform_comments_subplugin extends backup_subplugin {
    ...
    protected function define_workshep_subplugin_structure() {
        ...
        $subplugindimension = new backup_nested_element('workshepform_comments_dimension', array('id'), array(
        ...
        $subplugindimension->set_source_table('workshepform_comments', array('workshepid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('workshepform_comments', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_comments_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_comments_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_comments_grade');
    }
