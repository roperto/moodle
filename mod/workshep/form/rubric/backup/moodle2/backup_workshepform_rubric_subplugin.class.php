 ...
 */
class backup_workshepform_rubric_subplugin extends backup_subplugin {
    ...
    protected function define_workshep_subplugin_structure() {
        ...
        $subpluginconfig = new backup_nested_element('workshepform_rubric_config', null, 'layout');
        $subplugindimension = new backup_nested_element('workshepform_rubric_dimension', array('id'), array(
            'sort', 'description', 'descriptionformat'));
        $subpluginlevel = new backup_nested_element('workshepform_rubric_level', array('id'), array(
        ...
        $subpluginconfig->set_source_table('workshepform_rubric_config', array('workshepid' => backup::VAR_ACTIVITYID));
        $subplugindimension->set_source_table('workshepform_rubric', array('workshepid' => backup::VAR_ACTIVITYID));
        $subpluginlevel->set_source_table('workshepform_rubric_levels', array('dimensionid' => backup::VAR_PARENTID));

        // file annotations
        $subplugindimension->annotate_files('workshepform_rubric', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_rubric_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_rubric_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_rubric_grade');
    }
