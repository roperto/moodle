 ...
 */
class backup_workshepform_numerrors_subplugin extends backup_subplugin {
    ...
    protected function define_workshep_subplugin_structure() {
        ...
        $subpluginmap = new backup_nested_element('workshepform_numerrors_map', array('id'), array(
            'nonegative', 'grade'));
        $subplugindimension = new backup_nested_element('workshepform_numerrors_dimension', array('id'), array(
        ...
        $subpluginmap->set_source_table('workshepform_numerrors_map', array('workshepid' => backup::VAR_ACTIVITYID));
        $subplugindimension->set_source_table('workshepform_numerrors', array('workshepid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('workshepform_numerrors', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_numerrors_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_numerrors_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_numerrors_grade');
    }
