...
$settings->add(new admin_setting_configselect('workshepeval_best/bcomparison', get_string('comparison', 'workshepeval_best'),
                    get_string('configcomparison', 'workshepeval_best'), 5, $options));
